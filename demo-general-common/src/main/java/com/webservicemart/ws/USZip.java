 ...
 * 
 */
@WebServiceClient(name = "USZip", targetNamespace = "http://webservicemart.com/ws/", wsdlLocation = "http://www.webservicemart.com/uszip.asmx?WSDL")
public class USZip
    extends Service
{
    ...
    private final static QName USZIP_QNAME = new QName("http://webservicemart.com/ws/", "USZip");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://www.webservicemart.com/uszip.asmx?WSDL");
    ...
    public USZipSoap getUSZipSoap() {
        return super.getPort(new QName("http://webservicemart.com/ws/", "USZipSoap"), USZipSoap.class);
    }
    ...
    public USZipSoap getUSZipSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://webservicemart.com/ws/", "USZipSoap"), USZipSoap.class, features);
    }
